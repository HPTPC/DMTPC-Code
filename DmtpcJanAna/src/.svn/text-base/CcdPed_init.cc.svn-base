...
//=======================================
//=======================================
void dmtpc::jana::CcdPedMaker::initDims(const dmtpc::core::Dataset *ds , int camid,  int camsrc) {
  clear();
  quadId=camid;
  camDaq=camsrc;

  printf(" CcdPedMaker()::initDims  quadId=%d  camDaq=%d  \n", quadId,camDaq);
  coreName=Form("quad%d",quadId);
...
//=======================================
//=======================================
void dmtpc::jana::CcdPedMaker::saveHisto(TFile *fd, int flag) {
...
//=======================================
//=======================================
void dmtpc::jana::CcdPedMaker::ingest_pedSpecBig(TString fName) {

  TFile *fd=new TFile(fName);
  assert(fd->IsOpen());
  
  hBigPed=(TH2S*) fd->Get(Form("quad%d_bigPed",quadId));
  if(hBigPed==0) fd->ls();
  assert(hBigPed);
  ...
  TH1D *hA0=(TH1D *)fd->Get(Form("quad%d_case",quadId));
  assert(hA0);
...
//=======================================
//=======================================
void dmtpc::jana::CcdPedMaker::adjustCuts(){ 
  cut_peakSum*=NtotEve;
...
//=======================================
//=======================================
void dmtpc::jana::CcdPedMaker::initHisto() {
  ...
  //tmp
  int mxV1=50000;
  hA[1]=new TH1I("ha","single pix A; raw (adu)",mxV1/10,0,mxV1);
  hA[2]=new TH1I("hb","single pix B; raw (adu)",mxV1/10,0,mxV1);
  hA[3]=new TH1I("hc","single pix C; raw (adu)",mxV1/10,0,mxV1);
  hA[4]=new TH1I("hd","single pix D; raw (adu)",mxV1/10,0,mxV1);
  //tmp
#endif
