...
ClassImp(dmtpc::jana::CcdPedMaker); 

//=======================================
//=======================================
dmtpc::jana::CcdPedMaker::CcdPedMaker() {
...
//=======================================
//=======================================
void dmtpc::jana::CcdPedMaker::clear() {
  if(h2GarbCol) {
    delete h2GarbCol;
    h2GarbCol=0;
  }
...
//=======================================
//=======================================
void dmtpc::jana::CcdPedMaker::initMask(){
  assert(hPedStat);
...
//=======================================
//=======================================
void dmtpc::jana::CcdPedMaker::accumulatePed(const dmtpc::core::Event * eve) {
  clear();
  NtotEve++;
  assert( NtotEve>0);  
  assert(eve);
  ...
  if(NtotEve%20==1 ) {
    ...
    printf(" reading4ped  frame=%d image camDaq=%d quadId=%d SN=%s   temp/C=%.1f\n", eve->ev(),camDaq,quadId, info->serialNumber.Data(), info->ccdTemp);
  }
...
#if 0      //tmp
      if(mBin==451564) hA[1]->Fill( rawVal);
      if(mBin==854974) hA[2]->Fill( rawVal);
      if(mBin==451565) hA[3]->Fill( rawVal);
      if(mBin==854975) hA[4]->Fill( rawVal);
#endif      //tmp
...
//=======================================
//=======================================
int dmtpc::jana::CcdPedMaker::computePed(){
  printf("CcdPedMaker::evalPed start quad=%d\n",quadId);
...
//=======================================
//=======================================
void dmtpc::jana::CcdPedMaker::findPedPeak(TH2S *h2, PedInfo *item, int flag){
