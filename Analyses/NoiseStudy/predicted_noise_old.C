{
  ...
  double exp[8] = {1.0,2.0,5.0,10.0,15.0,30.0,60,120};
 ...
 //for(int c = 0; c < ncam; c++){
  ...
  Double_t noise_meassured[3] = {12.41,13.12,15.15};
  Double_t ex[3] = {.2,.2,.5};
  Double_t ey[3] = {.3,.3,.2};
  ...
  leg->AddEntry(gr1,"Predicted Noise","l");
  leg->AddEntry(gr2,"Measured Noise","p");
  leg->Draw();
