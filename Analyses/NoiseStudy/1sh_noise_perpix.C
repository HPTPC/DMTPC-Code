{
  ...
  double exp[8] = {1.0,2.0,3.0,5.0,10.0,15.0,20.0,30.0};
 ...
 //for(int c = 0; c < ncam; c++){
  ...
  Double_t noise_meassured[8] = {10.87,11.06,11.21,11.64,12.01,14.3,17.4,25.417};
  Double_t ex[8] = {.75,.81,.5,1,.9,.5,.7,.1};
  Double_t ey[8] = {.8,.7,2.,.8,1.,2.,1.5,1.91};
