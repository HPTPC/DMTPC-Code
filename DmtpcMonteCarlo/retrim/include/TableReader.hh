#ifndef DMTPC_MC_RETRIM_TABLE_READER__HH
#define DMTPC_MC_RETRIM_TABLE_READER__HH

class TTree; 
#include "TGraph.h" 
#include <vector> 

/* Alternative implementation of SRIM Table Reader that provides tree*/ 
/* Also I didn't notice that Jeremy had already rewritten this... */ 
