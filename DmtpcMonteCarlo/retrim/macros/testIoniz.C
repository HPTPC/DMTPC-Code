...
//  dmtpc::mc::retrim::CollisionReader c("data/coll/COLLISON_200keV.txt"); 
  dmtpc::mc::retrim::CollisionReader c("data/c/60torr/coll/COLLISON_150.00keV.txt"); 
  dmtpc::mc::retrim::TableReader * tables[3]; 
  tables[1] = new dmtpc::mc::retrim::TableReader("data/srim/f_in_cf4_60torr.txt"); 
  tables[0] = new dmtpc::mc::retrim::TableReader("data/srim/c_in_cf4_60torr.txt"); 
...
//  t.getStats()->Draw("ElecLoss:predictedElecLoss","predictedElecLoss < 0.1","colz"); 
  ...
  dmtpc::mc::retrim::HistogramReader::readIONIZ("data/c/60torr/ioniz/IONIZ_150.00keV.txt",&true_ion, &true_recoil); 
  ...
  dmtpc::mc::retrim::HistogramReader::readPHONON(TString::Format("data/c/60torr/phonon/PHONON150.00keV.txt"),&phonon_true_ion, &phonon_true_recoil); 
