...
dmtpc::mc::retrim::SimpleIonizationModel::SimpleIonizationModel(double Wev, double fano_factor) 
{
...
int dmtpc::mc::retrim::SimpleIonizationModel::makeElectrons(size_t n, const TVector3 * start, const TVector3 * end, const double * t0, const double * t1, const  double *  dE,
