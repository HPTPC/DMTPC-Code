...
int dmtpc::mc::retrim::HistogramReader::readPHONON(const char * file, TH1F ** ion, TH1F** recoil)
{
...
int dmtpc::mc::retrim::HistogramReader::readIONIZ(const char * file, TH1F ** ion, TH1F** recoil)
{
