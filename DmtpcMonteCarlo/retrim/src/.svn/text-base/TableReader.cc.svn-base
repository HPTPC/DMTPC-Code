...
dmtpc::mc::retrim::TableReader::TableReader(const char * fname) 
{
...
dmtpc::mc::retrim::TableReader::~TableReader()
{
...
void dmtpc::mc::retrim::TableReader::writeROOTFile(const char * fname, const char *option) const
{
