...
double dmtpc::mc::retrim::CollisionReader::getDisplacementEnergy(int Z) const
{
...
double dmtpc::mc::retrim::CollisionReader::getLatticeEnergy(int Z) const
{
  for (unsigned i = 0; i < Zs.size(); i++)
  {
    if (Z == Zs[i]) 
...
double dmtpc::mc::retrim::CollisionReader::getSurfaceEnergy(int Z) const
{
  for (unsigned i = 0; i < Zs.size(); i++)
  {
    if (Z == Zs[i]) 
...
dmtpc::mc::retrim::CollisionReader::CollisionReader(const char * fname) 
{
...
int dmtpc::mc::retrim::CollisionReader::readAscii(const char * fname)
{
...
int dmtpc::mc::retrim::CollisionReader::drawTrack(int t, const char * opt) const
{
...
int dmtpc::mc::retrim::CollisionReader::drawCollision(int t, int i, const char * opt) const
{
...
int dmtpc::mc::retrim::CollisionReader::readBinary(const char * file) 
{
...
int dmtpc::mc::retrim::CollisionReader::writeBinary(const char * file)  const
{
