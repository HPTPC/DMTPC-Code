...
dmtpc::mc::retrim::ConstantEnergyLossModel::ConstantEnergyLossModel(int ntables, const TableReader ** tables, double ratio, double maxnuke)
...
float dmtpc::mc::retrim::ConstantEnergyLossModel::getIonMass(int species) const 
{
  return srim[Zs[species]]->getIonMass(); 
}

double dmtpc::mc::retrim::ConstantEnergyLossModel::getRange(int species, double E) const 
{
  return srim[Zs[species]]->getRange(E); 
}


dmtpc::mc::retrim::EnergyLoss dmtpc::mc::retrim::ConstantEnergyLossModel::ConstantEnergyLossModel::dE(int species, double Estart, double distance) const
{
